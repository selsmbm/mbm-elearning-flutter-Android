...
import 'package:mbm_elearning/Presentation/Screens/Dashboard/AddMaterial.dart';
import 'package:mbm_elearning/Presentation/Screens/Dashboard/Bookmark.dart';
...
import 'package:mbm_elearning/Presentation/Screens/Dashboard/gate_material.dart';
import 'package:mbm_elearning/Presentation/Screens/Dashboard/profile_page.dart';
import 'package:mbm_elearning/Presentation/Screens/Dashboard/search_page.dart';
...
import 'Data/Repository/AddAndGetDataFromApi.dart';
import 'Presentation/Screens/Dashboard/Material.dart';
  ...
  Widget build(BuildContext context) {
    return AnimatedBuilder(
      ...
      builder: (BuildContext context, Widget? child) {
        return BlocProvider(
          create: (context) => GetMaterialApiBloc(AllNetworkRequest()),
          child: MaterialApp(
            title: Flavors.title,
            ...
            routes: {
              ...
              'materialPage': (context) => MaterialsPage(),
